...
const double R = 6.3143502719;
const double C = 0.3;
const double V0 = 0;
const double V1 = 3.77728;

double f1(double x, double y1, double /*y2*/) {
    // dV/dt = (20 - V(t)) / (R*C)
    // Usamos x como "t" y y1 como V(t)
    (void)x;
    double numer = (20.0 - y1);
    double denom = (R * C);
    return numer / denom;
}
...
int main() {
    double a=0,b=5,y10=0.0,y20=0.0,h=0.1; int n; char modo;
    n=(b-a)/h;
